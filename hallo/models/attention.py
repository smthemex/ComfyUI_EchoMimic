...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        if cross_attention_dim is not None or double_self_attention:
            ...
            self.attn2 = Attention(
                ...
                dropout=dropout,
                bias=attention_bias,
                upcast_attention=upcast_attention,#fauls
    ...
    def forward(
        ...
        #hidden_states.shape  6, 4096, 320
        ...
        if self.attn2 is not None:
            ...
            elif self.use_ada_layer_norm_zero or self.use_layer_norm:#6, 4096, 320
            ...
            attn_output = self.attn2(
                norm_hidden_states,#6, 4096, 320]
                encoder_hidden_states=encoder_hidden_states,#2, 4, 768
                attention_mask=encoder_attention_mask,#None
                **cross_attention_kwargs,
            )
            print(attn_output.shape,hidden_states.shape)
            hidden_states = attn_output + hidden_states  #!![2, 12288, 320] !=[6, 4096, 320]
