...
def init_retinaface_model(model_name, half=False, device='cuda'):
    ...
    elif 'net0.25' in model_name.lower():
    ...
    load_net = torch.load(model_name, map_location=lambda storage, loc: storage)
...
def init_yolov5face_model(model_name, device='cuda'):
    if "yolov5l" in model_name.lower():
    ...
    elif "yolov5n" in model_name.lower():
